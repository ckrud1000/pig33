...
with tab1:
    ...
    class_status = pd.DataFrame({
        "학년": ["1학년", "1학년", "1학년", "2학년", "2학년", "2학년", "3학년", "3학년", "3학년"],
        "반": ["1~5반", "6~9반", "10~13반", "1~5반", "6~9반", "10~12반", "1~5반", "6~9반", "10~12반"],
        "현재 상태": ["🟢 즉시 이동", "🟡 교실 대기", "🔴 이동 제한", "🟢 즉시 이동", "🟡 교실 대기", "🔴 이동 제한", "🟢 식사 중", "🟢 식사 중", "🟢 식사 중"]
    })
...
with tab2:
    ...
    # [수정 완료] 시간대 리스트에 "12:45"를 추가해 아래 status(6개)와 개수를 일치시킴
    def get_congestion(day):
        times = ["11:30", "11:45", "12:00", "12:15", "12:30", "12:45"]
        if day == "수요일":  
